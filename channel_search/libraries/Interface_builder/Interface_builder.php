...
class Interface_Builder {
	...
	public function fieldsets($fieldsets = FALSE, $data = FALSE)
	{
		...
		foreach($fieldsets as $fieldset_id => $fieldset)
		{
			...
			$html[] = $this->table(array($fieldset_id => $fieldset), $data, $fieldset->attributes);
	...
	public function table($fields = FALSE, $data = FALSE, $attributes = array())
	{
		$html   = array();
	...
	public function build($fieldsets = FALSE, $data = FALSE)
	{
		$return = array();
	...
	public function add_fieldset($id, $fieldset)
	{
		...
		$this->fieldsets[$id] = $this->set_default_values($fieldset, $default);

		$this->add_fields($id, $this->fieldsets[$id]->fields);
	}
	...
	public function add_field($fieldset, $name, $field = array())
	{
		...
		$this->fieldsets[$fieldset]->fields[$name] = $this->set_default_values($field, $default);
	}
	...
	{
		return $this->fieldsets[$fieldset_id]['fields'];
	}

	public function get_field($fieldset_id, $field_name)
	{
		return $this->fieldsets[$fieldset_id]->fields[$field_name];
	}

	public function remove_field($fieldset_id, $name)
	{
		unset($this->fieldsets[$fieldset_id]->fields[$name]);
	}

	public function remove_fields($fieldset_id)
	{
		$this->fieldsets[$fieldset_id]->fields = array();
	}
